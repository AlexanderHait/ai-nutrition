export default function MichelinSections() {
  return (
    <style>{`
      ...
      .todayNumbers small{display:block;color:#777;font-size:11px;text-transform:uppercase;letter-spacing:.08em}
      .todayNumbers>b{display:block;margin-top:6px;font-size:28px;letter-spacing:-.8px}
      .todayNumbers>b em{font-style:normal;font-size:12px;color:#777;font-weight:500}
      .todayNumbers p{margin:5px 0 0;color:#a6a8a4;font-size:11px}
      ...
      .todayMacros span,.todayMacros small{display:block;color:#777;font-size:11px}
      ...
      .todayActions>span a{color:#949793;font-size:11.5px}
      ...
      .nextMealCard small{display:block;color:#777;font-size:11px}
      .nextMealCard b{display:block;margin-top:3px;font-size:13px}
      .nextMealCard p{margin:3px 0 0;color:#858885;font-size:11.5px}
      ...
      .signalRow span{display:grid}.signalRow b{font-size:11px}.signalRow small{margin-top:2px;color:#777;font-size:11px;line-height:1.45}
      ...
      .coachHomeGrid small{display:block;color:#83754f;font-size:11px;text-transform:uppercase;letter-spacing:.07em}
      .coachHomeGrid b{display:block;margin-top:4px;font-size:13px}.coachHomeGrid p{margin:6px 0 0;color:#8c8f8b;font-size:11.5px;line-height:1.55;white-space:pre-wrap}
      ...
      .premiumQuietInvite b,.allToolsQuiet b,.criticalSystemBanner b,.healthySystemBanner b{font-size:11px}
      .premiumQuietInvite small,.allToolsQuiet small,.criticalSystemBanner small,.healthySystemBanner small{margin-top:2px;color:#777;font-size:11px}
      .premiumQuietInvite strong{color:#9b9d99;font-size:11.5px}
      ...
      .periodSwitch a{padding:7px 12px;border-radius:8px;color:#777;font-size:11.5px;font-weight:700}
      ...
      .progressNarrative small{display:block;color:#777;font-size:11px;text-transform:uppercase;letter-spacing:.08em}
      .progressNarrative b{display:block;margin-top:3px;font-size:15px}.progressNarrative p{margin:5px 0 0;color:#9a9d99;font-size:11px;line-height:1.5}.progressNarrative span{display:block;margin-top:5px;color:#737673;font-size:11px}
      ...
      .goalJourney small{display:block;color:#777;font-size:11px}.goalJourney b{display:flex;align-items:center;gap:7px;margin-top:4px;font-size:15px}.goalJourney p{margin:4px 0 0;color:#777;font-size:11px}
      ...
      .period90 .periodBar{flex-basis:42px}.periodBar>span{font-size:10.5px;color:#6f7270}
      ...
      .periodBar>div em{position:absolute;left:0;right:0;border-top:1px dashed #575249}.periodBar>small{font-size:10.5px;color:#6d706d;padding-top:4px}
      ...
      .macroSummaryCard span,.macroSummaryCard small,.macroSummaryCard em{display:block}.macroSummaryCard span{color:#777;font-size:11px}.macroSummaryCard b{margin-top:5px;font-size:16px}
      .macroSummaryCard small{margin-top:2px;color:#777;font-size:11px}.macroSummaryCard em{margin-top:7px;color:#9a9d99;font-size:11px;font-style:normal}
      ...
      .profileHub span{display:grid}.profileHub b{font-size:11px}.profileHub small{margin-top:2px;color:#777;font-size:11px}.profileHub>a>svg{color:#666}
      ...
      .coachDecision small{display:block;color:#84764f;font-size:11px;text-transform:uppercase;letter-spacing:.08em}.coachDecision h2{margin:4px 0 3px;font-size:18px}.coachDecision p{margin:0;color:#858885;font-size:11.5px}
      .coachWorkGrid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.coachText{color:#b8bab6;font-size:11px;line-height:1.65;white-space:pre-wrap}
      ...
      .coachSituations span{display:grid}.coachSituations b{font-size:11px}.coachSituations small{margin-top:2px;color:#777;font-size:11px}.coachSituations svg{color:#666}
