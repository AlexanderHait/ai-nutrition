...
import {Activity,BarChart3,BrainCircuit,CreditCard,Crown,Database,Headphones,History,LayoutDashboard,LockKeyhole,MessageSquare,Send,Settings2,TrendingUp,UserRound,Users,Utensils,Workflow} from "lucide-react";
export type IconKey="home"|"coach"|"clients"|"dialogs"|"activity"|"analytics"|"catalog"|"mailings"|"subscriptions"|"nutrition"|"progress"|"history"|"support"|"profile"|"plan"|"settings"|"n8n";
export type NavItem=readonly[string,string,IconKey,({premium?:boolean})?];
const ICONS={home:LayoutDashboard,coach:BrainCircuit,clients:Users,dialogs:MessageSquare,activity:Activity,analytics:BarChart3,catalog:Database,mailings:Send,subscriptions:CreditCard,nutrition:Utensils,progress:TrendingUp,history:History,support:Headphones,profile:UserRound,plan:Crown,settings:Settings2,n8n:Workflow} satisfies Record<IconKey,React.ComponentType<{size?:number;strokeWidth?:number}>>;
