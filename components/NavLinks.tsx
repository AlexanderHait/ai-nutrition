...
import {Activity,BarChart3,BrainCircuit,CreditCard,Crown,Database,Headphones,LayoutDashboard,MessageSquare,Send,TrendingUp,UserRound,Users,Utensils} from "lucide-react";
type IconKey="home"|"coach"|"clients"|"dialogs"|"activity"|"analytics"|"catalog"|"mailings"|"subscriptions"|"nutrition"|"progress"|"support"|"profile"|"plan";
