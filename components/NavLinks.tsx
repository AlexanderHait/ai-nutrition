...
import {Activity,BarChart3,BrainCircuit,CreditCard,Crown,Database,Headphones,LayoutDashboard,LockKeyhole,MessageSquare,Send,Settings2,TrendingUp,UserRound,Users,Utensils,Workflow} from "lucide-react";
export type IconKey="home"|"coach"|"clients"|"dialogs"|"activity"|"analytics"|"catalog"|"mailings"|"subscriptions"|"nutrition"|"progress"|"support"|"profile"|"plan"|"settings"|"n8n";
