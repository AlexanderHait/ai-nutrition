...
.planStatusBadge{display:inline-flex;align-items:center;gap:6px;justify-self:start;padding:4px 10px;border-radius:999px;font-size:10px;font-weight:800;letter-spacing:.04em;border:1px solid #2c2f35;background:#0c0d10;color:var(--tier-free)}
...
.planMeterTop small{font-size:10px;color:#83867f;text-transform:uppercase;letter-spacing:.08em}
...
.trialCta small{font-size:10px;font-weight:800;letter-spacing:.09em;text-transform:uppercase;color:var(--tier-premium)}
...
.planColTag{position:absolute;top:0;right:0;padding:3px 9px;border-bottom-left-radius:9px;background:linear-gradient(90deg,var(--tier-premium),var(--tier-premium-2));color:#14120c;font-size:8.5px;font-weight:900;letter-spacing:.05em;text-transform:uppercase}
...
.planCol>strong small{color:#797c78;font-size:10px;font-weight:600;letter-spacing:0}
...
.planGroup h3{margin:0 0 8px;font-size:9px;font-weight:800;letter-spacing:.13em;text-transform:uppercase;color:#5f6361}
...
.planRowName small{font-size:10px;color:#747774}
