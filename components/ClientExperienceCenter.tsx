  ...
  return (
    <>
      <style>{`
        ...
        .experienceCenterBadge{position:absolute;top:-5px;right:-5px;min-width:18px;height:18px;padding:0 5px;border-radius:999px;display:grid;place-items:center;background:#d8b85f;color:#111;font-size:11px;font-weight:900;border:2px solid #0a0b0d}
        ...
        .experiencePanelHead h2{margin:0;font-size:16px}.experiencePanelHead span{display:block;color:#777b78;font-size:11.5px;margin-top:3px}
        ...
        .experienceNotice b{display:block;font-size:12px}.experienceNotice small{display:block;margin-top:3px;color:#888b88;font-size:11.5px;line-height:1.4}
        .experienceNotice>svg{margin-top:7px;color:#666a67}
        .experienceSectionTitle{margin:15px 0 8px;color:#666a67;font-size:11px;text-transform:uppercase;letter-spacing:.11em;font-weight:800}
        ...
        .achievementItem b{display:block;font-size:11px}.achievementItem small{display:block;color:#7e817b;font-size:11px;margin-top:2px}
        ...
        .premiumMoment b{display:block;font-size:12px}.premiumMoment p{margin:4px 0 9px;color:#96978f;font-size:11.5px;line-height:1.4}.premiumMoment a{display:inline-flex;align-items:center;gap:5px;color:#dfbd66;font-size:11.5px;font-weight:800}
