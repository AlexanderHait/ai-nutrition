...
### Известное расхождение (требует проверки)

У `tg_callbacks_...v23` в описании написано «Keep unpublished until pin-data and webhook cutover checks pass», у `AI_Nutrition_Telegram_Ingress_v20_REPAIR_v2` — «unpublished and inactive». По факту оба `active: true`. Либо описания устарели после публикации, либо публикация прошла без нужных проверок. Разобраться и привести описания в соответствие.
